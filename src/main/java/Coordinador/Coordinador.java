...
public class Coordinador extends UnicastRemoteObject implements ICoordinador {
    ...
    private static  List <String> ultimoContenidoLeidoFichero;
    ...
    public void cargarMonitor(String contenidoFichero) {
        Coordinador.ultimoContenidoLeidoFichero.add(contenidoFichero);
        //System.out.println("Valor leido numero: {" + ++this.contador + "} del fichero: " + contenidoFichero);
        //forEach(UltimoContenidoLeidoFichero as Cargas) {System.out.println(Cargas); }
        ultimoContenidoLeidoFichero.forEach(Cargas -> {
    ...
    public void obtenerUltimoContenido() {
        System.out.println("Ultimo valor leido: " + Coordinador.ultimoContenidoLeidoFichero);
    }
